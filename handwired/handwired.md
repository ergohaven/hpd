...
Для сборки холдера (контроллера) нам потребуется его распечатанный корпус (ссылка), RP2040 Zero, плата с разъемом USB Type-C и немного проводка

Первым делом припаиваем провода к плате с разъемом USB Type-C (для удобства лучше использовать проводки различных цветов)
...
Первым делом припаиваем по четыре провода к платам с разъемом USB Type-C (для удобства лучше использовать проводки различных цветов)
