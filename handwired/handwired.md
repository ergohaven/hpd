...
{{< callout type="warning" >}}
  В данном руководстве не затронута сборка модулей для клавиатуры HPDv2, так как навесной монтаж компонентов и разъемов не является надежным для модулей.
{{< /callout >}}
...
| Hotswap sockets (опционально) | 60 |
| Switch | 60 |
| Keycaps | 60 |
| M3x4 Screws | 10 |
| 3M bumpons (8mm) | 4 |
