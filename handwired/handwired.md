...
> 💡 Вставим свитчи контактами вниз в верхнюю строку для удобства сборки
![image](images/hpd_hw_bg_01_6.png)
![image](images/hpd_hw_bg_01_7.png)

Вставляем хотсвапы на обе половинки 
> 💡 Для свитчей верхней строки разверните хотсвапы на 180 градусов
...
- Повторяем это же действие в третий и четвертый раз, по итогу должен получиться проводок с 5 оголенными местами (сегментами) на жиле
